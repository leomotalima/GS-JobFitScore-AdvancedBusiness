...
namespace JobFitScoreAPI.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_USUARIO_HABILIDADE_usuario_id_habilidade_id",
                table: "USUARIO_HABILIDADE",
                columns: new[] { "usuario_id", "habilidade_id" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VAGA_HABILIDADE_vaga_id_habilidade_id",
                table: "VAGA_HABILIDADE",
                columns: new[] { "vaga_id", "habilidade_id" },
                unique: true);
